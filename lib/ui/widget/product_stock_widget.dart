  ...
  Container _buildImage(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        border: Border.all(color: Color.fromARGB(255, 108, 107, 107)),
      ),
      height: 120,
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Text(productModel.stockPiece.toString(), style: contentStyle),
          ],
        ),
        Row(
          children: [
            Text(ProductStockStatusText.birimFiyati, style: titleStyle),
            Text(productModel.unitPrice.toString(), style: contentStyle),
          ],
        ),
        Row(
          children: [
            Text(ProductStockStatusText.netFiyat, style: titleStyle),
            Text(productModel.totalPrice.toString(), style: contentStyle),
          ],
        ),
        Row(
          children: [
            Text(ProductStockStatusText.kdv, style: titleStyle),
            Text(productModel.kdv.toString(), style: contentStyle),
          ],
        ),
        Wrap(
          children: [
